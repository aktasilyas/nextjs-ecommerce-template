        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div className="flex flex-col gap-4.5">
              <button disabled className="flex justify-center items-center gap-3.5 rounded-lg border border-gray-3 bg-gray-1 p-3 ease-out duration-200 hover:bg-gray-2 opacity-50 cursor-not-allowed">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
            ...
            <div className="mt-5.5">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5.5">
                  <label htmlFor="rePassword" className="block mb-2.5">
